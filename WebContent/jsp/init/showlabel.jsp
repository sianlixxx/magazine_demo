...
<head>
    <meta charset="utf-8">
    <title>首次登陆</title>
    <link href="${magroot}/css/main.css" rel="stylesheet" type="text/css" />
...
<body>
    <div class="content1">
      <div class="banner">
        <span><a href="">首页<a href="">剪报</a>  <a href="" >微博</a><a href="" >编辑部</a><a href="" >广场</a></span>
           <div class="search"><span>
             <input name="input" type="text" class="textinput" />
             <input name="input2" type="button" class="go" />
           </span>
           </div>
           <div class="bannerright"> <span><a href="">首页<a href="">剪报</a>  <a href="" >微博</a><a href="" >编辑部</a><a href="" >广场</a></span></div>
      </div>
    </div>
	...
	<div class="contentlogin">
      ...
      <div class="list">
        ...
        <div class="mag-label-explain">
            <p>关于标签
            <ul>
                <li>·可以通过自定义来丰富你的标签</li>
                <li>·根据你的微博标签和自定义标签，推荐给你最适合阅读的杂志</li>
            </ul>
      ...
      <div class="mag-put">
          ...
          <div class="row-fluid">
            <div class="span6">
                <img class="mag-put-pic" alt="" src="${magroot}/images/weibook/img9.png" width="70" height="70">
    ...
    <script type="text/javascript">
        $(document).ready(function(){
        	...
        	//<a href="#" class="btn btn-small btn-info"><i class="icon-plus icon-white"></i>音乐</a>
            ...
            $('.mag-label-change span a').click(function() {
            	...
            	var selectLabel = [];
            	for(var j = 0; j < 9; j++) {
            		selectLabel.push(Math.floor(Math.random()*labels.length));
            	}
            	selectLabel = $.unique(selectLabel);
