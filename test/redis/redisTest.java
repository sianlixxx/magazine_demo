...
public class redisTest {
    ...
    @Before
    public void setUp() {
        pool = new JedisPool(new JedisPoolConfig(), "172.20.50.19");
...
//	        jedis.hdel("user","pwd");
	   ...
	   /**
	    ...
	    public void testSet(){
	        ...
	        //添加
	        jedis.sadd("sname2","minxr");
	        jedis.sadd("sname2","jarorwar");
	        jedis.sadd("sname2","闵晓荣");
	        jedis.sadd("sanm2e","noname");
	        //移除noname
	        jedis.srem("sname2","noname");
	        System.out.println(jedis.smembers("sname2"));//获取所有加入的value
	        
	        System.out.println(jedis.del("sname"));//获取所有加入的value
	        System.out.println(jedis.smembers("sname"));//获取所有加入的value
	        System.out.println(jedis.smembers("sname2"));//获取所有加入的value
