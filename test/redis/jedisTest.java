...
{ 
    ...
    { 
        ...
        ShardedJedis shardedJedis3 = shardedJedisPool.getResource(); 
    ...
    { 
        ...
        shards.add(new JedisShardInfo("127.0.0.2", 6379, "salve")); 
        shards.add(new JedisShardInfo("127.0.0.3", 6379, "salve")); 
    ...
    { 
        ...
        labels =  shardedJedis.smembers("sets");
       System.out.println(labels.iterator().next()); 
